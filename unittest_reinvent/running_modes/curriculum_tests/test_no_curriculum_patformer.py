...
class TestNoCurriculumPatformer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        agent_config = ModelConfiguration(model_type.PATFORMER, model_regime.INFERENCE, PATFORMER_PRIOR_PATH)
    ...
    def _create_configuration(self, smiles):
        ...
        curriculum_config = CurriculumStrategyInputConfiguration(name=self.cs_enum.NO_CURRICULUM,
                                                                 input=smiles,
