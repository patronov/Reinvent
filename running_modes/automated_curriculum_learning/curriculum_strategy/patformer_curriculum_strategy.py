...
from running_modes.automated_curriculum_learning.actions.patformer_sample_model import PatformerSampleModel
...
class PatformerCurriculumStrategy(BaseCurriculumStrategy):
    ...
    def _sampling(self, agent) -> List[SampledSequencesDTO]:
        sampling_action = PatformerSampleModel(agent, self._parameters.batch_size, self._logger,
